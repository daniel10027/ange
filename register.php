      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <div class="col-md-12">
                ...
                <input class="form-control" id="exampleInputNam" type="text"   name="localite" value="" required="VEILLEZ RENSEIGNER TOUS LES CHAMPS">
              </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
           ...
           <button type="submit" class="btn btn-primary btn-block" name="submit1">Enregistrer</button><br>
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="login.php">J'ai un compte</a>
