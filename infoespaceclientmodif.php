...
<body style= "background-color:  #999E42;" >
  <div class="animated bounceInLeft">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form method="post" action="updateinfoespaceclients.php" role='form'>
        ...
        <div class="form-group">
          ...
          <center>  <button class="btn btn-primary btn-block" type="button" name="else"><a href="infoespaceclient.php"  style="color: white;">Annuler</a></button></center>
          <br>
        </form>
